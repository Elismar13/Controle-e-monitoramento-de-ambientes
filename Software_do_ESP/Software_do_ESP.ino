...
void verificacaodeTempo();                        //Função para verificar e printar o tempo
void Conexao_Rede();
...
float Temperaturas(int porta_sensor_temperatura)
{
  ...
  float temperatura = (float(mediafinal *5/2047))/0.01;   //Calculo da temperatura
